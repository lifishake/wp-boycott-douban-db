...
class BDDB_Common_Template
{
    ...
    public function __construct($post_type = false)
    {
        ...
        $this->common_items = array(
            'bddb_display_name' => array(
                'name' => 'bddb_display_name',
                'label' => '表示名',
                'priority' => '10',
                'portrait_ok' => true,
            ),
            'bddb_original_name' => array(
                'name' => 'bddb_original_name',
                'label' => '原名',
                'summary' => '01',
                'summary_callback' => [$this, 'display_original_name'],
                'panel' => '01',
                'panel_callback' => [$this, 'panel_original_name'],
            ),
            'bddb_aka' => array(
                'name' => 'bddb_aka',
                'label' => '别名',
            ),
            'bddb_personal_review' => array(
                'name' => 'bddb_personal_review',
                'label' => '简评',
            ),
            'bddb_external_link' => array(
                'name' => 'bddb_external_link',
                'label' => '外部链接',
            ),
            'bddb_poster_link' => array(
                'name' => 'bddb_poster_link',
                'label' => '图片链接',
            ),
            'bddb_publish_time' => array(
                'name' => 'bddb_publish_time',
                'label' => '出版时间',
                'priority' => '03',
                'sort' => 'DESC',
                'summary' => '21',
     ...
     * @version	1.3.2
     */
    public function create_from_full_args($args): void
    {
        if (
            !is_array($args) ||
     ...
     * @version	0.4.0
     */
    public function the_gallery(): void
    {
     ...
     * @date    2026-07-06
     */
    public function ajax_get_gallery_page(): void
    {
     ...
     * @version	0.3.9
     */
    public function get_gallery_page($page_id, $in_str = ""): void
    {
     ...
     * @see		qt_show_record()
     */
    public function get_record_outer_link($id): string
    {
    ...
    public function show_record($atts, $content = null): string
    {
        ...
        if (empty($src_is_series)) {
            ...
            if ($src_score < 0 || $src_score > 100) {
                ...
                if ($src_score >= 0)
                    $subject_class .= " my-score-" . $my_score;

            }
            $rating_str = sprintf(
                '<span class="allstardark">%1$s%2$s</span>',
                sprintf('<span class="dou-stars-%s"></span>', $src_score_social),
                sprintf('<span class="my-stars-%s"></span>', $my_score)
            );
            //5.详情
            $abstract_str = $this->template_type_callable("get_", "_abstract", $id);
            ...
            $abstract_str = $this->template_type_callable("get_", "_abstract_series", $id);
     ...
     * @version	0.0.1
     */
    private function get_tax_str($tax_name, $id): string
    {
        $val_str = '';
     ...
     * @version	0.5.5
     */
    private function get_first_tax_str($tax_name, $id): string
    {
        $val_str = '';
        $str_array = wp_get_post_terms($id, $tax_name, array('fields' => 'names'));
        if (is_wp_error($str_array))
    ...
    private function set_working_mode($post_type)
    {
        ...
        $this->template_type_callable("add_", "_items");
        $this->total_items = array_map([$this, 'merge_default_column'], $this->total_items);
     ...
     * @date    2026-07-06
     */
    protected function template_type_callable($before, $after, ...$args)
    {
        $method = $before . $this->self_post_type . $after;
     ...
     */
    private function add_movie_items(): void
    {
        ...
        $this->common_items['bddb_publish_time']['panel_callback'] = [$this, 'panel_time_only_year'];
        $this->common_items['bddb_view_time']['label'] = '观看时间';
        $this->common_items['bddb_view_time']['panel'] = '03';			//上墙显示。
        $this->common_items['bddb_view_time']['panel_callback'] = [$this, 'panel_time_only_year'];
        $this->common_items['bddb_publish_time']['summary_callback'] = [$this, 'display_movie_publish_time'];
        $add_items = array(
            'm_region' => array(
                'name' => 'm_region',
                'label' => '地区',
            ...
            'm_p_actor' => array(
                ...
                'summary' => '03',			//插入显示。
                'panel' => '12',			//上墙显示。
                'panel_callback' => [$this, 'panel_movie_people'],
                'portrait_ok' => true,
            ),
            'm_genre' => array(
                'name' => 'm_genre',
            ...
            'm_p_screenwriter' => array(
                'name' => 'm_p_screenwriter',
                'label' => '编剧',
                'type' => 'tax',
            ),
            'm_p_musician' => array(
            ...
            'm_misc_brand' => array(
                ...
                'type' => 'tax',
                'summary' => '61',			//插入显示。
                'summary_callback' => [$this, 'display_movie_misc'],
                'panel' => '99',			//上墙显示。
                'panel_callback' => [$this, 'panel_movie_misc'],
            ),
            'bddb_id_douban' => array(
                'name' => 'bddb_id_douban',
                'label' => '豆瓣ID',
            ),
            'bddb_score_douban' => array(
                'name' => 'bddb_score_douban',
                'label' => '豆瓣评分',
            ),
            'm_id_imdb' => array(
                'name' => 'm_id_imdb',
     ...
     * @see		set_working_mode()->add_{$this->self_post_type}_items
     */
    private function add_book_items(): void
    {
        $this->common_items['bddb_display_name']['label'] = '书名';
        $this->common_items['bddb_publish_time']['label'] = '出版时间';
        $this->common_items['bddb_publish_time']['summary_callback'] = [$this, 'display_book_publish_time'];
        $this->common_items['bddb_publish_time']['panel'] = '02';		//上墙显示
        $this->common_items['bddb_publish_time']['panel_callback'] = [$this, 'panel_book_publish_time'];
        ...
        $add_items = array(
            ...
            'b_series_total' => array(
                'name' => 'b_series_total',
                'label' => '全套册数',
                'summary' => '31',
                'summary_callback' => [$this, 'display_book_series_total'],
                'panel' => '05',
                'panel_callback' => [$this, 'panel_book_series_total'],
            ),
            'bddb_id_douban' => array(
                'name' => 'bddb_id_douban',
                'label' => '豆瓣ID',
            ...
            'b_misc_brand' => array(
                ...
                'type' => 'tax',
                'summary' => '99',
                'summary_callback' => [$this, 'display_book_misc'],
                'panel' => '99',
                'panel_callback' => [$this, 'panel_book_misc'],
            ),
            'b_bl_series' => array(
                'name' => 'b_bl_series',
                'label' => '是否丛书',
            ),
            'b_pub_time_end' => array(
                'name' => 'b_pub_time_end',
                'label' => '最终出版时间',
            ),
            'b_series_covers' => array(
                'name' => 'b_series_covers',
                'label' => '系列封面',
            ),
        );
        $this->total_items = array_merge($this->common_items, $add_items);
     ...
     * @see		set_working_mode()->add_{$this->self_post_type}_items
     */
    private function add_game_items(): void
    {
        ...
        $add_items = array(
            ...
            'g_misc_brand' => array(
                ...
                'type' => 'tax',
                'summary' => '99',
                'summary_callback' => [$this, 'display_game_misc'],
                'panel' => '99',
                'panel_callback' => [$this, 'panel_game_misc'],
            ),
     ...
     * @see		set_working_mode()->add_{$this->self_post_type}_items
     */
    private function add_album_items(): void
    {
        ...
        $add_items = array(
            'a_region' => array(
                ...
                'panel' => '04',
                'portrait_ok' => true,
                'panel_callback' => [$this, 'panel_album_region'],
            ),
            'a_language' => array(
                'name' => 'a_language',
                'label' => '语言',
            ...
            'a_p_musician' => array(
                ...
                'type' => 'tax',
                'summary' => '02',
                'summary_callback' => [$this, 'summary_album_musician'],
                'panel' => '01',
                'panel_callback' => [$this, 'panel_album_musician'],
                'portrait_ok' => true,
            ),
            'a_p_asstants' => array(
                'name' => 'a_p_asstants',
            ...
            'a_quantity' => array(
                ...
                'panel' => '10',
                'summary' => false,
                'panel_callback' => [$this, 'panel_album_quantity'],
                'portrait_ok' => true,
            ),
            'a_publisher' => array(
                'name' => 'a_publisher',
            ...
            'a_bl_multicreator' => array(
                'name' => 'a_bl_multicreator',
                'label' => '多人创作',
            ),
            'bddb_id_douban' => array(
                'name' => 'bddb_id_douban',
     ...
     */
    protected function merge_default_column($inItem): array
    {
        if (!is_array($inItem)) {
    ...
    private function get_order_args(): array
    {
        $ret = array();
        //TODO:画面点击后AJAX变化
        $priority = array_column($this->total_items, 'priority');
        array_multisort($priority, array_column($this->total_items, 'name'), $this->total_items);
    ...
    private function get_poster_for_gallery($id): string
    {
        ...
        //get_xxx_info
        $info_str = "";
        $rtr = $this->template_type_callable("get_", "_panel_info", $id);
        if ($rtr) {
            $info_str .= $rtr;
        }
     ...
     */
    private function get_movie_panel_info($id): string
    {
        //title
     ...
     * @see		the_gallery()->get_poster_for_gallery()->get_{$this->self_post_type}_panel_info
     */
    private function get_book_panel_info($id): string
    {
        //title
        $detail_str = $this->get_panel_title($id);
        //stars
     ...
     * @see		the_gallery()->get_poster_for_gallery()->get_{$this->self_post_type}_panel_info
     */
    private function get_game_panel_info($id): string
    {
        //title
        $detail_str = $this->get_panel_title($id);
        //stars
     ...
     * @see		the_gallery()->get_poster_for_gallery()->get_{$this->self_post_type}_panel_info
     */
    private function get_album_panel_info($id): string
    {
        //title
        $detail_str = $this->get_panel_title($id);
        //stars
     ...
     */
    private function get_movie_poster_class($id): string
    {
        return "";
    }
     ...
     * @see		the_gallery()->get_poster_for_gallery()->get_{$this->self_post_type}_poster_class
     */
    private function get_book_poster_class($id): string
    {
        return "";
    }
     ...
     * @see		the_gallery()->get_poster_for_gallery()->get_{$this->self_post_type}_poster_class
     */
    private function get_game_poster_class($id): string
    {
        return "";
    }
     ...
     * @see		the_gallery()->get_poster_for_gallery()->get_{$this->self_post_type}_poster_class
     */
    private function get_album_poster_class($id): string
    {
        $ret = '';
        $the_class = '';
     ...
     * @see		get_xxx_info()
     */
    private function get_panel_title($id): string
    {
     ...
     * @see		get_xxx_info()
     */
    private function get_panel_rating_stars($id): string
    {
        $stars = '';
        $emp_stars = '';
        $i = 1;
     ...
     */
    private function panel_common_loop($id): string
    {
        $panel_str = '';
        foreach ($this->total_items as $key => $item) {
            if (!$item['panel'])
     ...
     */
    private function get_movie_abstract($id): string
    {
     ...
     * @see		show_record()->get_{$this->self_post_type}_abstract
     */
    private function get_book_abstract($id): string
    {
        return $this->abstract_common_loop($id);
    }
    /**
     ...
     * @see		show_record()->get_{$this->self_post_type}_abstract
     */
    private function get_game_abstract($id): string
    {
        return $this->abstract_common_loop($id);
    }
     ...
     * @see		show_record()->get_{$this->self_post_type}_abstract
     */
    private function get_album_abstract($id): string
    {
        return $this->abstract_common_loop($id);
    }
    /**
     ...
     */
    private function get_book_abstract_series($id): string
    {
     ...
     * @see		show_record()->get_{$this->self_post_type}_abstract
     */
    private function abstract_common_loop($id): string
    {
        $abs_str = '';
        foreach ($this->total_items as $key => $item) {
            if (!$item['summary'])
     ...
     * @see		show_record()->get_{$this->self_post_type}_abstract
     */
    private function get_summary_social_stars($id): string
    {
        $src_score_social = '0';
...
class BDDB_Book
{
    public static ?BDDB_Common_Template $class_self = null;
